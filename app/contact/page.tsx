...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (response.ok) {
        toast.success("Thank you! Your booking request has been sent successfully. Our team will contact you within 24 hours.");
        setFormData({
          name: "",
          email: "",
          phone: "",
        ...
        const errorMsg = data.message || "Unable to send your booking request. Please check your information and try again.";
    ...
    <main className="w-full min-h-screen bg-white py-20 px-4 lg:px-20">
      <div className="text-center mb-16">
        ...
        <p className="text-black lg:text-[1.25vw] text-[3.5vw] max-w-3xl mx-auto mb-8">
          Please fill in the form below and our team will contact you within 24 hours to confirm your session.
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          <div className="lg:col-span-5">
            <div className="bg-[#0E7EA0] text-white p-8 rounded-lg h-full flex flex-col justify-between">
              <div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-semibold text-[#FFD700]">Our Address</h4>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-semibold text-[#FFD700]">Email Us</h4>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-semibold text-[#FFD700]">Call Us</h4>
                      <p>+1 (555) 123-4567</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="mt-10">
                <h4 className="font-semibold mb-3 text-[#FFD700]">Follow Us</h4>
          ...
          <div className="lg:col-span-7">
            <form onSubmit={handleSubmit} className="space-y-6 text-black">
              ...
              <div>
                <p className="block text-sm font-medium text-gray-700 mb-3">Preferred Mode of Session</p>
                <div className="flex items-center space-x-6">
                  ...
                  <div className="flex items-center">
                    <input
                      ...
                      name="sessionMode"
                      value="Online (Video)"
                      checked={formData.sessionMode.includes('Online (Video)')}
                      onChange={handleCheckboxChange}
                      className="h-4 w-4 text-[#0E7EA0] focus:ring-[#0E7EA0] border-gray-300 rounded"
                    />
              ...
              <div>
                <label htmlFor="preferredDaysTiming" className="block text-sm font-medium text-gray-700 mb-1">
              ...
              <div className="text-right">
                {errorMessage && (
                  <div className="mb-4 p-3 bg-red-50 text-red-700 rounded-lg text-left">
                    ...
                    <p className="text-xs mt-1">If issues persist, please email us directly at support@manokalp.com</p>
                  </div>
                )}
                <button
                  type="submit"
                ...
                <p className="text-xs text-gray-500 mt-2 text-center">Our care coordinator will respond shortly.</p>
              </div>
            </form>
          </div>
        </div>
