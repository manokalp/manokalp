    ...
    return (
        <main className="w-full h-full flex justify-center flex-col  bg-white ">
            ...
            <div className="w-full hidden lg:block text-center ">
                ...
                <Image src="/anxiety.webp" alt="hero image" objectFit="cover" width={1200} height={100} className="w-full  lg:mt-[-16vw] mt-[-25vw]  z-0" />
            </div>

            {/* ASPD Hero Mobile  */}
            <div className="w-full lg:hidden block text-center ">

                <Image src="/anxiety.webp" alt="hero image" objectFit="cover" width={1200} height={100} className="w-full z-0" />
            ...
            {/*  Links  */}
            <section className="bg-white w-full h-full lg:px-20 px-10 lg:py-20 py-10 text-center">
                <h2 className={`text-[#0E7EA0] lg:text-[3.8vw] text-[7vw] font-semibold  ${playfair.className}`}>Solutions for Managing Anxiety Spectrum Disorders</h2>
                <p className="text-black lg:text-[1.35vw] text-[3.5vw] font-medium mb-10">Effectively managing anxiety involves a combination of self-care strategies, therapy, 
