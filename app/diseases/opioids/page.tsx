  ...
  return (
    <main className="w-full h-full flex justify-center flex-col  bg-white ">
      ...
      <div className="w-full hidden lg:block text-center ">
        ...
        <Image
          src="/diseases-banner/opioids.webp"
          alt="opioid addiction hero image"
          objectFit="cover"
          width={1200}
          height={100}
      ...
      {/* <section className="bg-[#FFD266] w-full h-full lg:px-80 px-10 lg:pt-20 lg:pb-[50vw] pt-20 pb-50 mb-[-60vw] text-center z-0 ">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center text-left text-black gap-20 mb-50">
            <p className="lg:text-[1.2vw] text-[3.5vw]">Recovery from opioid addiction is challenging but possible with appropriate treatment. The journey often requires multiple approaches and ongoing support, with many individuals achieving sustained recovery through comprehensive treatment plans tailored to their unique needs and circumstances.</p>
            <p className="lg:text-[1.2vw] text-[3.5vw]">While relapse rates are high with opioid addiction, each treatment episode can bring valuable learning and progress. With proper medical care, psychological support, and social reintegration, individuals can overcome opioid dependency and rebuild healthy, productive lives free from substance use.</p>
        </div>
      </section> */}
    </main>
  );
...
export default OpioidsAddiction;
