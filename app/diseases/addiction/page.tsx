    ...
    return (
        <main className="w-full h-full flex justify-center flex-col  bg-white ">
            ...
            <div className="w-full hidden lg:block text-center ">
                ...
                <Image src="/diseases-banner/addiction.webp" alt="hero image" objectFit="cover" width={1200} height={100} className="w-full  lg:mt-[-16vw] mt-[-25vw]  z-0" />
            </div>

            {/* ASPD Hero Mobile  */}
            <div className="w-full lg:hidden block text-center ">

                <Image src="/diseases-banner/addiction.webp" alt="hero image" objectFit="cover" width={1200} height={100} className="w-full     z-0" />
            ...
            <section className="bg-[#0E7EA0] rounded-full w-full h-full lg:px-40 px-10 lg:py-20 py-20 text-center lg:mt-[-20vw] mt-[-0vw]">
                ...
                <div className="flex flex-col lg:flex-row justify-center lg:gap-20 gap-10 items-center text-center mb-20">
                    ...
                    <p className="lg:text-[1.55vw] text-[3.5vw] font-medium text-left">Addiction is a multifaceted disorder that affects millions of individuals across the globe. It is defined by compulsive use of a substance or behavior in the face of adverse effects. Addiction exists in a variety of forms, ranging from substance abuse (e.g., drugs and alcohol) to behavioral addictions (e.g., gambling, social media, or gaming).</p>
            ...
            <section className="bg-white w-full h-full lg:px-40 px-10 lg:py-20 py-10 text-center">
                ...
                <div className="grid lg:grid-cols-5 grid-cols-1 gap-4 mb-60">
                    ...
                    <div className="[perspective:1000px] cursor-pointer ">
                        <div className="relative w-full aspect-square transition-all duration-500 [transform-style:preserve-3d] hover:[transform:rotateY(180deg)]">
                            ...
                            <div className="absolute inset-0 bg-[#0E7EA0] w-full lg:lg:h-[50vh] rounded-xl p-6 text-white flex flex-col items-center justify-center [transform:rotateY(180deg)] [backface-visibility:hidden]">
                                <p className="lg:text-[1vw] text-[3vw]"> Research indicates that genetic makeup plays an important part in addiction. People who have a history of addiction in their families are likely to develop such issues.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="[perspective:1000px] cursor-pointer">
                        <div className="relative w-full aspect-square transition-all duration-500 [transform-style:preserve-3d] hover:[transform:rotateY(180deg)]">
                            <div className="absolute inset-0 bg-[#FFD700] w-full lg:h-[50vh] rounded-xl p-6 text-black flex flex-col items-center justify-center [backface-visibility:hidden]">
                                <h3 className="lg:text-[1.25vw] text-[4vw] font-bold">Brain Chemistry and Reward System</h3>
                            </div>
                            <div className="absolute inset-0 bg-[#FFD700] w-full lg:h-[50vh] rounded-xl p-6 text-black flex flex-col items-center justify-center [transform:rotateY(180deg)] [backface-visibility:hidden]">
                                <p className="lg:text-[1vw] text-[3vw]">Addictive drugs and activities activate the reward system of the brain by releasing dopamine, a pleasure-related neurotransmitter. Gradually, repeated use leads to a change in brain chemistry such that it is hard to experience pleasure without using the addictive drug or engaging in the addictive activity.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="[perspective:1000px] cursor-pointer">
                        <div className="relative w-full aspect-square transition-all duration-500 [transform-style:preserve-3d] hover:[transform:rotateY(180deg)]">
                            <div className="absolute inset-0 bg-[#0E7EA0]  w-full lg:h-[50vh] rounded-xl p-6 text-white flex flex-col items-center justify-center [backface-visibility:hidden]">
                                <h3 className="lg:text-[1.25vw] text-[4vw] font-bold">Environmental Causes</h3>
                            </div>
                            <div className="absolute inset-0 bg-[#0E7EA0] w-full lg:h-[50vh] rounded-xl p-6 text-white flex flex-col items-center justify-center [transform:rotateY(180deg)] [backface-visibility:hidden]">
                                <p className="lg:text-[1vw] text-[3vw]">Substance exposure at an early age, peer pressure, stress, and trauma can cause addiction. Individuals who are exposed to addiction while growing up at home or to high-stress environments are at higher risk.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="[perspective:1000px] cursor-pointer">
                        <div className="relative w-full aspect-square transition-all duration-500 [transform-style:preserve-3d] hover:[transform:rotateY(180deg)]">
                            <div className="absolute inset-0 bg-[#FFD700] w-full lg:h-[50vh] rounded-xl p-6 text-black flex flex-col items-center justify-center [backface-visibility:hidden]">
                                <h3 className="lg:text-[1.25vw] text-[4vw] font-bold">Lack of Healthy Coping Mechanisms</h3>
                            </div>
                            <div className="absolute inset-0 bg-[#FFD700] w-full lg:h-[50vh] rounded-xl p-6 text-black flex flex-col items-center justify-center [transform:rotateY(180deg)] [backface-visibility:hidden]">
                                <p className="lg:text-[1vw] text-[3vw]">Some people use addictive substances or activities as a means of coping with emotional hurt, boredom, or stress, instead of learning to cope in healthy ways.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="[perspective:1000px] cursor-pointer">
                        <div className="relative w-full aspect-square transition-all duration-500 [transform-style:preserve-3d] hover:[transform:rotateY(180deg)]">
                            <div className="absolute inset-0 bg-[#0E7EA0] w-full lg:h-[50vh] rounded-xl p-6 text-white flex flex-col items-center justify-center [backface-visibility:hidden]">
                                <h3 className="lg:text-[1.25vw] text-[4vw] font-bold">Social and Cultural Influences</h3>
                            </div>
                            <div className="absolute inset-0 bg-[#0E7EA0] w-full lg:h-[50vh] rounded-xl p-6 text-white flex flex-col items-center justify-center [transform:rotateY(180deg)] [backface-visibility:hidden]">
                                <p className="lg:text-[1vw] text-[3vw]">Culture and society can make addictive behavior the norm, i.e., the use of excessive amounts of alcohol, tobacco, or gambling, and it becomes easy for people to become addicted to them.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="bg-white w-full h-full lg:px-20 px-10 lg:py-20 py-10 text-center">
                <h2 className={`text-[#0E7EA0] lg:text-[4vw] text-[7vw] font-semibold  ${playfair.className}`}>Symptoms of Addiction</h2>
                <p className="text-black lg:text-[1.55vw] text-[3.5vw] font-medium mb-10">Addiction symptoms may differ based on the substance or activity, but typical signs include:</p>
            ...
            <section className="bg-white w-full h-full lg:px-40 px-10 lg:py-20 py-10 text-center pb-2">
                ...
                <div className="flex flex-col lg:flex-row justify-between gap-8 text-left">
                    <div className="bg-white border-b-2 border-[1px] text-black p-8 flex-1">
                        ...
                        <p className="text-sm">The initial step towards recovery is admitting the addiction and the necessity for help.</p>
                    </div>

                    <div className="bg-white border-b-2 border-[1px] text-black p-8 flex-1">
                        <h3 className="text-xl font-bold mb-4">Professional Treatment</h3>
                        <p className="text-sm">Professional treatment for addiction involves therapy, counseling, rehabilitation centers, and medical treatment.</p>
                    </div>
                ...
                <div className="flex flex-col lg:flex-row justify-between gap-8 text-left mt-8">
                    <div className="bg-white border-b-2 border-[1px] text-black p-8 flex-1">
                        ...
                        <p className="text-sm">In the case of substance addiction, detox is usually required to eliminate harmful substances from the body under medical care.</p>
                    </div>
                    <div className="bg-white border-b-2 border-[1px] text-black p-8 flex-1">
                        <h3 className="text-xl font-bold mb-4">Support Groups</h3>
                        <p className="text-sm">Organizations such as Alcoholics Anonymous (AA) offer peer support and encouragement by individuals who have knowledge of the challenges of addiction.</p>
                    </div>
                ...
                <div className="flex flex-col lg:flex-row justify-between gap-8 text-left mt-8">
                    <div className="bg-white border-b-2 border-[1px] text-black p-8 flex-1">
                        <h3 className="text-xl font-bold mb-4">Building Healthy Coping Mechanisms</h3>
                        <p className="text-sm">Creating new interests, exercise, meditation, or engaging in meaningful pursuits can help replace addictive activities.</p>
                    </div>

                    <div className="bg-white border-b-2 border-[1px] text-black p-8 flex-1">
                        <h3 className="text-xl font-bold mb-4">Steering Clear of Triggers</h3>
                        <p className="text-sm">Finding out and steering clear of things, places, or individuals that foster addictive tendencies can help prevent relapse.</p>
                    </div>

                </div>
                <div className="flex flex-col lg:flex-row justify-between gap-8 text-left mt-8">
                    <div className="bg-white border-b-2 border-[1px] text-black p-8 flex-1">
                        <h3 className="text-xl font-bold mb-4">Cognitive Behavioral Therapy (CBT)</h3>
                        <p className="text-sm">CBT assists the individual in understanding and modifying negative thought processes and behaviors that enable addiction.</p>
                    </div>

                    <div className="bg-white border-b-2 border-[1px] text-black p-8 flex-1">
                        <h3 className="text-xl font-bold mb-4">Medication-Assisted Treatment (MAT)</h3>
                        <p className="text-sm">Certain addictions, e.g. opioid or alcohol addiction, are treated using medications that lessen the cravings and withdrawal symptoms.</p>
                    </div>
                </div>

                <div className="flex flex-col lg:flex-row justify-between gap-8 text-left my-8">
                    <div className="bg-white border-b-2 border-[1px] text-black p-8 flex-1">
                        <h3 className="text-xl font-bold mb-4">Creating a Healthy Support Network</h3>
                        <p className="text-sm">Being around positive family, friends, or mentors can motivate and hold accountable.</p>
                    </div>
                    <div className="bg-white border-b-2 border-[1px] text-black p-8 flex-1">
                        <h3 className="text-xl font-bold mb-4">Creating a Healthy Support Network</h3>
                        <p className="text-sm">Being around positive family, friends, or mentors can motivate and hold accountable.</p>
