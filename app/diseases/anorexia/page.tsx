  ...
  const solutionsData = [
    {
      ...
      description:
        "Reframes distorted beliefs about food, control, and self-image to develop healthier thinking and behavior patterns.",
    },
    {
      title: "Dialectical Behavior Therapy (DBT)",
      description:
        "Enhances emotional regulation, impulse control, and distress tolerance, especially during binge or purge urges.",
    },
    {
      title: "Family-Based Therapy (FBT)",
      description:
        "Actively involves family in adolescent recovery by restoring eating patterns and supporting emotional healing.",
    },
    {
      title: "Nutritional Counseling",
      description:
        "Guides individuals toward balanced eating habits, portion control, and awareness of hunger cues.",
    },
    {
      title: "Inpatient or Residential Treatment",
      description:
        "Provides structured care for severe cases with health risks or coexisting psychological symptoms.",
    },
    {
      title: "Peer and Support Groups",
      description:
        "Encourage sharing experiences, maintaining progress, and reducing isolation in the recovery journey.",
    },
    {
    ...
    },
    {
      ...
      description:
        "Body-positive education, early screening, and open dialogue in schools and sports environments reduce long-term impact.",
    },
  ];
  ...
  return (
    <main className="w-full h-full flex justify-center flex-col  bg-white ">
      ...
      <div className="w-full hidden lg:block text-center ">
        ...
        <Image
          src="/diseases-banner/anorexia.webp"
          alt="hero image"
          objectFit="cover"
          width={1200}
          height={100}
      ...
      <section className="bg-white w-full h-full lg:px-60 px-10 lg:py-20 py-10 text-center">
        ...
        <p className="text-black lg:text-[1.5vw] text-[3vw] mb-10">
          ...
          overlapping signs across emotional, behavioral, cognitive, and
          physical domains.
        </p>
