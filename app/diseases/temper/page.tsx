    ...
    return (
        <main className="w-full h-full flex justify-center flex-col  bg-white ">
            ...
            <div className="w-full hidden lg:block text-center ">
                ...
                <Image src="/temper.webp" alt="hero image" objectFit="cover" width={1200} height={100} className="w-full  lg:mt-[-16vw] mt-[-25vw]  z-0" />
            </div>

            {/* ASPD Hero Mobile  */}
            <div className="w-full lg:hidden block text-center ">

                <Image src="/temper.webp" alt="hero image" objectFit="cover" width={1200} height={100} className="w-full     z-0" />
