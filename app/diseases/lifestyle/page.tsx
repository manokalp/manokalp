  ...
  return (
    <main className="w-full h-full flex justify-center flex-col  bg-white ">
      ...
      <div className="w-full hidden lg:block text-center ">
        ...
        <Image
          src="/diseases-banner/lifestyle.webp"
          alt="hero image"
          objectFit="cover"
          width={1200}
          height={100}
      ...
      <section className="bg-[#0E7EA0] rounded-full w-full h-full lg:px-40 px-10 lg:py-20 py-20 text-center lg:mt-[-20vw] mt-[-0vw]">
        ...
        <div className="flex flex-col lg:flex-row justify-center lg:gap-20 gap-10 items-center text-center mb-20">
          ...
          <p className="lg:text-[1.55vw] text-[3.5vw] font-medium text-left">
            ...
            stress, and harmful coping mechanisms. These conditions can become
            severe, leading to long-term health complications. Understanding the
            causes, symptoms, and remedies for lifestyle diseases is crucial for
      ...
      <section className="bg-white w-full h-full lg:px-60 px-10 lg:py-20 py-10 text-center">
        ...
        <p className="text-black lg:text-[1.5vw] text-[3vw] mb-10">
          Lifestyle Diseases Can Present A Wide Range Of Symptoms Depending On
            ...
            <div className="flex flex-col lg:flex-row justify-between items-center w-full">
              <div className="lg:w-1/2">
                <ul className="text-left text-black">
                  ...
                  <li className="mb-8 border-b-[2px]">
                    Joint and back pain due to excess weight
                  </li>
                  <li className="mb-8 border-b-[2px]">
                    Fatigue and reduced mobility
                  </li>
                  <li className="mb-8 border-b-[2px]">
                    Increased risk of other conditions like diabetes and heart
                    disease
                  </li>
                </ul>
              </div>
            ...
            <div className="flex flex-col lg:flex-row justify-between items-center w-full">
              <div className="lg:w-1/2">
                <ul className="text-left text-black">
                  ...
                  <li className="mb-8 border-b-[2px]">
                    Pain or numbness in arms or legs due to reduced blood flow
                  </li>
                  <li className="mb-8 border-b-[2px]">
            ...
            <div className="flex flex-col lg:flex-row justify-between items-center w-full">
              <div className="lg:w-1/2">
                <ul className="text-left text-black">
                  ...
                  <li className="mb-8 border-b-[2px]">
                    Physical symptoms like headaches or digestive issues with no
                    clear cause
                  </li>
                </ul>
              </div>
      ...
      <section className="bg-white w-full h-full lg:px-20 px-10 lg:py-20 py-10 text-center">
        ...
        <p className="text-black lg:text-[1.55vw] text-[3.5vw] font-medium mb-10">
          Preventing And Managing Lifestyle Diseases Requires A Comprehensive
