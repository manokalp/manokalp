  ...
  return (
    <main className="w-full h-full flex justify-center flex-col  bg-white ">
      ...
      <div className="w-full hidden lg:block text-center ">
        ...
        <Image
          src="/diseases-banner/anxiety.webp"
          alt="hero image"
          objectFit="cover"
          width={1200}
          height={100}
      ...
      <section className="bg-white w-full h-full lg:px-20 px-10 lg:py-20 py-10 text-center">
        ...
        >
          Causes of Anxiety Spectrum Disorders
        </h2>
        <p className="text-black lg:text-[1.25vw] text-[3.5vw] mb-10">
          Anxiety disorders can arise from a combination of biological,
          psychological, and environmental factors. Some of the most common
          causes include:
        </p>
          ...
          <div className="[perspective:1000px] cursor-pointer">
            <div className="relative w-full aspect-square transition-all duration-500 [transform-style:preserve-3d] hover:[transform:rotateY(180deg)]">
              ...
              <div className="absolute inset-0 bg-[#FFD700] w-full lg:h-[50vh] rounded-xl p-6 text-black flex flex-col items-center justify-center [transform:rotateY(180deg)] [backface-visibility:hidden]">
                <p className="lg:text-[1vw] text-[3vw]">
                  Imbalances in neurotransmitters such as serotonin, dopamine,
                  and gamma-aminobutyric acid (GABA) can contribute to
                  heightened anxiety.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col lg:flex-row justify-between items-center w-full">
              <div className="lg:w-1/2">
                <ul className="text-left text-black">
                  ...
                  <li className="mb-8 border-b-[2px]">
                    Questioning one&apos;s abilities or worth
                  </li>
                  <li className="mb-8 border-b-[2px]">
                  ...
                  <li className="mb-8 border-b-[2px]">
                    Perfectionist tendencies and unrealistic standards
                  </li>
                </ul>
              </div>
              <div className="lg:w-[40%] w-[80vw] h-[40vh] lg:mt-0 mt-8">
            ...
            <div className="flex flex-col lg:flex-row justify-between items-center w-full">
              <div className="lg:w-1/2">
                <ul className="text-left text-black">
                  ...
                  <li className="mb-8 border-b-[2px]">
                    Persistent fear of losing control
                  </li>
                </ul>
              </div>
              <div className="lg:w-[40%] w-[80vw] h-[40vh] lg:mt-0 mt-8">
      ...
      <section className="bg-white w-full h-full lg:px-20 px-10 lg:py-20 py-10 text-center">
        <h2
          className={`text-[#0E7EA0] lg:text-[3.8vw] text-[7vw] font-semibold ${playfair.className}`}
        >
        ...
        <div className="grid lg:grid-cols-4 grid-cols-1 gap-4">
          ...
          <div className="bg-[#0E7EA0] rounded-3xl text-white text-center">
            <Image
              src="https://images.pexels.com/photos/4099406/pexels-photo-4099406.jpeg"
              alt="therapist consulting client"
              width={300}
              height={200}
          ...
          <div className="bg-[#0E7EA0] rounded-3xl text-white text-center">
            ...
            <div className="p-6">
              ...
              <p className="text-sm">
                Practicing mindfulness techniques can help individuals stay
                present and reduce excessive worry.
              </p>
            </div>
          </div>
          ...
          <div className="bg-[#0E7EA0] rounded-3xl text-white text-center">
            <Image
              ...
              alt="person practicing breathing"
              width={300}
              height={200}
              className="w-full h-48 object-cover rounded-2xl mb-6"
            />
            <div className="p-6">
              ...
              <p className="text-sm">
                ...
                imagery help calm the nervous system.
              </p>
            </div>
          </div>
          ...
          <div className="bg-[#0E7EA0] rounded-3xl text-white text-center">
            <Image
              src="https://images.pexels.com/photos/290544/pexels-photo-290544.jpeg"
              alt="no alcohol and caffeine"
              width={300}
              height={200}
              className="w-full h-48 object-cover rounded-2xl mb-6"
            />
            <div className="p-6">
              ...
              <p className="text-sm">
                ...
                consumption can prevent anxiety triggers.
              </p>
            </div>
          </div>
          ...
          <div className="bg-[#0E7EA0] rounded-3xl text-white text-center">
            ...
            <div className="p-6">
              ...
              <p className="text-sm">
                Connecting with friends, family, or support groups can provide
          ...
          <div className="bg-[#0E7EA0] rounded-3xl text-white text-center">
            ...
            <div className="p-6">
              ...
              <p className="text-sm">
                Creating structured routines and setting realistic goals can
                prevent overwhelming stress.
              </p>
            </div>
          </div>
          ...
          <div className="bg-[#0E7EA0] rounded-3xl text-white text-center">
            <Image
              src="https://images.pexels.com/photos/4098230/pexels-photo-4098230.jpeg"
              alt="therapist guiding exposure"
              width={300}
              height={200}
              className="w-full h-48 object-cover rounded-2xl mb-6"
            />
            <div className="p-6">
              ...
              <p className="text-sm">
                Gradually confronting feared situations can help desensitize
                individuals to anxiety triggers.
              </p>
            </div>
          </div>
          ...
          <div className="bg-[#0E7EA0] rounded-3xl text-white text-center">
            ...
            <div className="p-6">
              ...
              <p className="text-sm">
                Writing about worries and emotions can provide clarity and
          ...
          <div className="bg-[#0E7EA0] rounded-3xl text-white text-center">
            <Image
              src="https://images.pexels.com/photos/5327859/pexels-photo-5327859.jpeg"
            ...
            <div className="p-6">
              ...
              <p className="text-sm">
                If anxiety becomes severe or debilitating, consulting a mental
                health professional can provide tailored treatment, including
      ...
      <section className="bg-[#FFD266] w-full h-full lg:px-40 px-10 lg:pt-20 lg:pb-[50vw] pt-20 pb-50 mb-[-60vw] text-center z-0 ">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center text-left text-black gap-20 mb-50">
          <p>
            Anxiety is a common and natural emotion, but when it becomes
            persistent, disproportionate, and disruptive to daily life, it can
            evolve into an anxiety disorder. Understanding the underlying
            causes, recognizing the symptoms, and seeking the right treatment
