  ...
  return (
    <main className="w-full h-full flex justify-center flex-col  bg-white ">
      ...
      <div className="w-full hidden lg:block text-center ">
        <h1 className="lg:text-[5vw] text-[6vw] text-white font-semibold relative z-10 font-[playfull] translate-y-[3vw]">What Are Forgetfulness and Dementia?</h1>
        <Image src="/diseases-banner/forgetfulness.webp" alt="hero image" objectFit="cover" width={1200} height={100} className="w-full  lg:mt-[-16vw] mt-[-25vw]  z-0" />
      </div>

      {/* ASPD Hero Mobile  */}
      <div className="w-full lg:hidden block text-center ">
        <Image src="/forg etfulness.webp" alt="hero image" objectFit="cover" width={1200} height={100} className="w-full  z-0" />
        <h1 className="lg:text-[5vw] text-[6vw] text-white font-semibold relative z-10 font-[playfull] mt-[-10vw] mb-10">What Are Forgetfulness and Dementia?</h1>
      </div>
      ...
      <section className="bg-[#0E7EA0] rounded-full w-full h-full lg:px-40 px-10 lg:py-20 py-20 text-center lg:mt-[-20vw] mt-[-0vw]">
        ...
        <div className="flex flex-col lg:flex-row justify-center lg:gap-20 gap-10 items-center text-center mb-20">
          ...
          <p className="lg:text-[1.55vw] text-[3.5vw] font-medium text-left">Forgetfulness and dementia refer to a spectrum of cognitive impairments affecting memory, reasoning, communication, and daily functioning. While occasional forgetfulness is common with aging, dementia is a progressive decline that</p>
          ...
          <div className="[perspective:1000px] cursor-pointer ">
            <div className="relative w-full aspect-square transition-all duration-500 [transform-style:preserve-3d] hover:[transform:rotateY(180deg)]">
              <div className="absolute inset-0 bg-[#0E7EA0] w-full lg:lg:h-[50vh] rounded-xl p-6 text-white flex flex-col items-center justify-center [backface-visibility:hidden]">
                <h3 className="lg:text-[1.0vw] text-[4vw] font-bold">Biological Factors
                </h3>
              </div>
              <div className="absolute inset-0 bg-[#0E7EA0] w-full lg:lg:h-[50vh] rounded-xl p-6 text-white flex flex-col items-center justify-center [transform:rotateY(180deg)] [backface-visibility:hidden]">
                <p className="lg:text-[1vw] text-[3vw]"> Degenerative diseases like Alzheimer’s and Parkinson’s, reduced cerebral blood flow, genetic predisposition, and neurotransmitter imbalances all contribute to sustained cognitive decline and memory loss.</p>
              </div>
            </div>
          </div>
          ...
          <div className="[perspective:1000px] cursor-pointer">
            <div className="relative w-full aspect-square transition-all duration-500 [transform-style:preserve-3d] hover:[transform:rotateY(180deg)]">
              <div className="absolute inset-0 bg-[#FFD700] w-full lg:h-[50vh] rounded-xl p-6 text-black flex flex-col items-center justify-center [backface-visibility:hidden]">
                <h3 className="lg:text-[1.0vw] text-[4vw] font-bold">Psychological and Environmental Factors</h3>
              </div>
              <div className="absolute inset-0 bg-[#FFD700] w-full lg:h-[50vh] rounded-xl p-6 text-black flex flex-col items-center justify-center [transform:rotateY(180deg)] [backface-visibility:hidden]">
                <p className="lg:text-[1vw] text-[3vw]">Chronic stress, depression, substance abuse, sedentary habits, and poor nutrition impair brain function and accelerate memory deterioration, especially in older adults.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="bg-white w-full h-full lg:px-60 px-10 lg:py-20 py-10 text-center">
        ...
        <p className="text-black lg:text-[1.5vw] text-[3vw] mb-10">
          Cognitive, emotional, and behavioral changes appear gradually
          and worsen over time, often leading to loss of independence.
        </p>
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center gap-8">
          ...
          <div className="lg:w-1/2 h-[60vh] relative overflow-hidden rounded-xl">
            <Image
              src={`/diseases/forgetfulness/${activeTab === 'emotional'
                ? '1'
      ...
      <section className="bg-white w-full h-full lg:px-20 px-10 lg:py-30 py-10 text-center">
        ...
        <p className="text-black lg:text-[1.55vw] text-[3.5vw] font-medium mb-10">
          While dementia cannot be reversed, appropriate therapies can help slow its progression and improve quality of life.
        </p>
